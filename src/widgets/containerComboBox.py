...
from PySide6.QtWidgets import QComboBox, QStylePainter, QStyle
    ...
    def paintEvent(self, event):
        ...
        if current_index >= 0:
            ...
            try:
                ...
                text_area = QRect(text_x, text_rect.top(), text_width, text_rect.height())
                ...
                painter.setPen(self.palette().color(self.palette().ColorRole.Text))
                painter.drawText(text_area, Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter, display_text)
