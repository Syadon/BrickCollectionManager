...
from PySide6.QtGui import QIcon, QFont, QPen, QColor, QPalette
...
class ContainerComboDelegate(QStyledItemDelegate):
    ...
    def paint(self, painter, option, index):
        ...
        try:
            container_id, container_name, container_type, part_count, container_description = container_data
        except (ValueError, TypeError):
            try:
                # Try format without description
                container_id, container_name, container_type, part_count = container_data
        ...
        painter.drawText(first_line_rect, Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter, first_line_text)
        ...
        if container_description:
            ...
            painter.drawText(description_rect, Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter, container_description)
    ...
    def sizeHint(self, option, index):
        ...
        return QSize(
            option.rect.width(),
            max(48, self.icon_size + (self.padding * 2))
        )
