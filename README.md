...
BrickCollectionManager data is fully local.
...
- Use of BrickLink part names.
- Import and search for pieces using XML files.
- Piece recognition using the camera (via Brickonize).
- Data is fully local.
